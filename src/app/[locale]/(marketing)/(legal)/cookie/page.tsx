...
export async function generateMetadata({
  ...
  if (locale !== DEFAULT_LOCALE) {
    return {
      alternates: {
        canonical: getUrlWithLocale('/cookie', DEFAULT_LOCALE),
      },
      robots: {
        index: false,
        follow: true,
  ...
  const page = pagesSource.getPage(['cookie-policy'], DEFAULT_LOCALE);
  ...
  return constructMetadata({
    ...
    pathname: '/cookie',
    alternateLanguages: {
      en: getUrlWithLocale('/cookie', DEFAULT_LOCALE),
    },
  });
}
