...
import HomeHeroSwitcher from '@/components/blocks/hero/home-hero-switcher';
import HomeVideoShowcase from '@/components/blocks/hero/home-video-showcase';
  ...
  return (
    <>
      <div className="flex flex-col">
        <HomeHeroSwitcher defaultMode={isVideoSite ? 'video' : 'image'} />

        {isVideoSite && <HomeVideoShowcase />}
