    ...
    >
      <Container className="px-4">
        ...
        <nav className="hidden lg:flex">
          ...
          {/* menu links */}
          <div className="flex-1 flex items-center justify-end mr-8 space-x-2">
          ...
          <div className="flex items-center gap-x-4">
            {mounted && !isPending && websiteConfig.credits.enableCredits && (
              <CreditsBalanceButton
                showPromo={websiteConfig.features.enableDailyCheckin}
              />
            )}
            {!mounted || isPending ? (
            ...
            {mounted &&
              !isPending &&
              !currentUser &&
              websiteConfig.ui.enableAuthButtons !== false && (
