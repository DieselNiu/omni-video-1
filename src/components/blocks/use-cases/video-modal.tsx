  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-[1280px] w-[84vw] h-[76vh] !p-0 !gap-0 !border-0 !bg-black overflow-hidden"
      >
        ...
        <div className="flex h-full flex-col lg:flex-row">
          {/* Video/Image Section */}
          <div className="relative w-full bg-black lg:w-[58%] lg:min-w-[540px] rounded-l-lg overflow-hidden">
            <div className="flex h-full w-full items-center justify-center">
              <div className="relative h-[76vh] w-full max-w-[880px] flex-shrink-0 overflow-hidden bg-black">
                {item.type === 'video' ? (
                  <video
                    src={item.src}
              ...
              <div className="flex flex-wrap items-center gap-6">
                <div>
                  ...
                  <div className="text-sm font-medium">
                    {websiteConfig.useCases.displayModel}
                  </div>
                </div>
                <div>
                  <div className="mb-1 text-xs text-muted-foreground">
