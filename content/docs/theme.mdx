...
Neutral theme - A clean, balanced theme with neutral colors

    </Tab>

    <Tab value='black'>

Black theme - A sleek, high-contrast theme with black backgrounds

    </Tab>

    <Tab value='vitepress'>

Vitepress theme - Inspired by the VitePress documentation style

    </Tab>

    <Tab value='dusk'>

Dusk theme - A warm, sunset-inspired color scheme

    </Tab>

    <Tab value='Catppuccin'>

Catppuccin theme - Popular pastel-based color palette

    </Tab>

    <Tab value='ocean'>

Ocean theme - Cool blue tones inspired by the ocean

    </Tab>

    <Tab value='purple'>

Purple theme - Rich purple hues for a unique look
